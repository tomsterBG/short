...
## A [CheckBox] with extra functionality.
##
##[br][br][b]Note:[/b] This assumes that the [PropertyBinding] class exists.

@tool
class_name ShortCheckBox extends CheckBox
...
## If true, enables binding [Node] properties when [method BaseButton._toggled] is called.
...
## Properties of this [ShortCheckBox] used for [member tooltip_format_string]. This is in CSV format.
