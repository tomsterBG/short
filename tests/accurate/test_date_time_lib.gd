...
func test_get_day_in_year():
	assert_eq(DateTimeLib.get_day_in_year(DateInfo.from_ymd(1999, Time.MONTH_JANUARY, 1)), 1)
	assert_eq(DateTimeLib.get_day_in_year(DateInfo.from_ymd(1999, Time.MONTH_MARCH, 3)), 62)
	assert_eq(DateTimeLib.get_day_in_year(DateInfo.from_ymd(1999, Time.MONTH_DECEMBER, 31)), 365)
	assert_eq(DateTimeLib.get_day_in_year(DateInfo.from_ymd(2000, Time.MONTH_DECEMBER, 31)), 366)
	assert_eq(DateTimeLib.get_day_in_year(DateInfo.from_ymd(2001, Time.MONTH_SEPTEMBER, 11)), 254)

func test_get_day_since_first_monday():
	assert_eq(DateTimeLib.get_day_since_first_monday(DateInfo.from_ymd(1999, Time.MONTH_SEPTEMBER, 11)), 251)
	assert_eq(DateTimeLib.get_day_since_first_monday(DateInfo.from_ymd(2005, Time.MONTH_SEPTEMBER, 11)), 252)
	assert_eq(DateTimeLib.get_day_since_first_monday(DateInfo.from_ymd(2006, Time.MONTH_SEPTEMBER, 11)), 253)
	assert_eq(DateTimeLib.get_day_since_first_monday(DateInfo.from_ymd(2007, Time.MONTH_SEPTEMBER, 11)), 254)
	assert_eq(DateTimeLib.get_day_since_first_monday(DateInfo.from_ymd(2013, Time.MONTH_SEPTEMBER, 11)), 255)
	assert_eq(DateTimeLib.get_day_since_first_monday(DateInfo.from_ymd(2014, Time.MONTH_SEPTEMBER, 11)), 256)
	assert_eq(DateTimeLib.get_day_since_first_monday(DateInfo.from_ymd(2015, Time.MONTH_SEPTEMBER, 11)), 257)
	assert_eq(DateTimeLib.get_day_since_first_monday(DateInfo.from_ymd(2016, Time.MONTH_DECEMBER, 31)), 363)
	assert_eq(DateTimeLib.get_day_since_first_monday(DateInfo.from_ymd(2017, Time.MONTH_JANUARY, 1)), 364)
	assert_eq(DateTimeLib.get_day_since_first_monday(DateInfo.from_ymd(2022, Time.MONTH_DECEMBER, 31)), 363)
	assert_eq(DateTimeLib.get_day_since_first_monday(DateInfo.from_ymd(2023, Time.MONTH_JANUARY, 1)), 364)
	assert_eq(DateTimeLib.get_day_since_first_monday(DateInfo.from_ymd(2024, Time.MONTH_JANUARY, 1)), 1)
	assert_eq(DateTimeLib.get_day_since_first_monday(DateInfo.from_ymd(2024, Time.MONTH_DECEMBER, 31)), 2)
	assert_eq(DateTimeLib.get_day_since_first_monday(DateInfo.from_ymd(2025, Time.MONTH_JANUARY, 1)), 3)
...
func test_get_weekday_of_date():
	assert_eq(DateTimeLib.get_weekday_of_date(DateInfo.from_ymd(2025, Time.MONTH_JANUARY, 1)), Time.WEEKDAY_WEDNESDAY)
	assert_eq(DateTimeLib.get_weekday_of_date(DateInfo.from_ymd(2025, Time.MONTH_JANUARY, 5)), Time.WEEKDAY_SUNDAY)

func test_get_iso_weekday_of_date():
	assert_eq(DateTimeLib.get_iso_weekday_of_date(DateInfo.from_ymd(2025, Time.MONTH_JANUARY, 1)), DateTimeLib.weekday_godot_to_iso(Time.WEEKDAY_WEDNESDAY))
	assert_eq(DateTimeLib.get_iso_weekday_of_date(DateInfo.from_ymd(2025, Time.MONTH_JANUARY, 5)), DateTimeLib.weekday_godot_to_iso(Time.WEEKDAY_SUNDAY))

func test_get_iso_first_monday_of_year():
	assert_eq(DateTimeLib.get_iso_first_monday_of_year(1999).to_timestamp().timestamp, DateInfo.from_ymd(1999, Time.MONTH_JANUARY, 4).to_timestamp().timestamp)
	assert_eq(DateTimeLib.get_iso_first_monday_of_year(2000).to_timestamp().timestamp, DateInfo.from_ymd(2000, Time.MONTH_JANUARY, 3).to_timestamp().timestamp)
	assert_eq(DateTimeLib.get_iso_first_monday_of_year(2006).to_timestamp().timestamp, DateInfo.from_ymd(2006, Time.MONTH_JANUARY, 2).to_timestamp().timestamp)
	assert_eq(DateTimeLib.get_iso_first_monday_of_year(2007).to_timestamp().timestamp, DateInfo.from_ymd(2007, Time.MONTH_JANUARY, 1).to_timestamp().timestamp)
	assert_eq(DateTimeLib.get_iso_first_monday_of_year(2008).to_timestamp().timestamp, DateInfo.from_ymd(2008, Time.MONTH_DECEMBER, 31).to_timestamp().timestamp)
	assert_eq(DateTimeLib.get_iso_first_monday_of_year(2014).to_timestamp().timestamp, DateInfo.from_ymd(2014, Time.MONTH_DECEMBER, 30).to_timestamp().timestamp)
	assert_eq(DateTimeLib.get_iso_first_monday_of_year(2015).to_timestamp().timestamp, DateInfo.from_ymd(2015, Time.MONTH_DECEMBER, 29).to_timestamp().timestamp)

func test_get_iso_week_number():
	assert_eq(DateTimeLib.get_iso_week_number(DateInfo.from_ymd(2015, Time.MONTH_OCTOBER, 26)), 44)
	assert_eq(DateTimeLib.get_iso_week_number(DateInfo.from_ymd(2023, Time.MONTH_JANUARY, 1)), 52)
	assert_eq(DateTimeLib.get_iso_week_number(DateInfo.from_ymd(2019, Time.MONTH_DECEMBER, 29)), 52)
	assert_eq(DateTimeLib.get_iso_week_number(DateInfo.from_ymd(2019, Time.MONTH_DECEMBER, 30)), 1)
	assert_eq(DateTimeLib.get_iso_week_number(DateInfo.from_ymd(2021, Time.MONTH_JANUARY, 3)), 53)
	assert_eq(DateTimeLib.get_iso_week_number(DateInfo.from_ymd(2021, Time.MONTH_JANUARY, 4)), 1)
	assert_eq(DateTimeLib.get_iso_week_number(DateInfo.from_ymd(2023, Time.MONTH_JANUARY, 2)), 1)
	assert_eq(DateTimeLib.get_iso_week_number(DateInfo.from_ymd(2023, Time.MONTH_AUGUST, 27)), 34)
	assert_eq(DateTimeLib.get_iso_week_number(DateInfo.from_ymd(2023, Time.MONTH_AUGUST, 28)), 35)
	assert_eq(DateTimeLib.get_iso_week_number(DateInfo.from_ymd(2023, Time.MONTH_SEPTEMBER, 3)), 35)
	assert_eq(DateTimeLib.get_iso_week_number(DateInfo.from_ymd(2023, Time.MONTH_SEPTEMBER, 4)), 36)
	assert_eq(DateTimeLib.get_iso_week_number(DateInfo.from_ymd(2025, Time.MONTH_JANUARY, 1)), 1)
