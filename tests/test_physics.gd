...
#region tests
func test_constants():
	assert_eq(Physics.GRAVITY_CONSTANT, 6.674 * pow(10, -11), "6.674 * 10^-11 ((N * m^2)/(kg^2))")
...
func test_get_gravity_between():
	assert_almost_eq(Physics.get_gravity_between(50.0, 80.0, 2.0), 6.674e-8, 1.0e-20, "Force between 2 point masses.")
